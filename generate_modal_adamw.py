"""
Generate images using the AdamW-trained LoRA on Modal.

Run:
    uv run modal run generate_modal_adamw.py
"""

import modal

app = modal.App("sdxl-lora-generate-adamw")

output_vol = modal.Volume.from_name("lora-output-adamw-v4")
...
def generate():
    ...
    output_vol.commit()
    print(f"\nDone! Download with: uv run modal volume get lora-output-adamw /generated_v3/ lora_output_adamw/generated_v3/")
